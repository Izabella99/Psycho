...
const Header = () => {
  ...
  return (
	  <div className='header'>
        <div className="row" id="psihologie_header">
			<div className="small-4 medium-4 large-4 columns" id="stanga_sus">
			...
			<div className="small-5 medium-5 large-5 columns" id="dreapta_sus">
